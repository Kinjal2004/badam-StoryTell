  ...
  return (
    <div className="relative">
      ...
      <textarea
        ...
        className="w-full h-48 p-4 border border-gray-300 rounded-lg resize-none text-gray-700 bg-gradient-to-br from-blue-300 to-pink-300 focus:outline-none focus:border-blue-500 transition duration-300 ease-in-out"
        onMouseEnter={handleHover}
        onMouseLeave={handleHoverOut}
      ></textarea>
    </div>
